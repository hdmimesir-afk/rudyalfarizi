      ...
      <div className="px-4 md:px-12">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-24">
          <div>
            ...
            <h2 className="font-serif text-2xl md:text-5xl font-light text-foreground leading-tight mb-6 lg:mb-0">
            ...
            <Accordion type="single" collapsible>
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  <AccordionContent className="text-foreground/40 text-xs md:text-sm pb-4 md:pb-6 leading-relaxed">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
