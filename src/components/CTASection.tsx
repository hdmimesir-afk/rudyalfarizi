    ...
    <section id="contact" className="py-14 md:py-48 bg-muted/20 border-t border-border">
      <div className="px-4 md:px-12 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-[8px] md:text-xs tracking-widest md:tracking-ultra uppercase border border-primary text-primary px-6 py-2.5 md:px-10 md:py-4 hover:bg-primary hover:text-primary-foreground transition-all duration-300"
        >
