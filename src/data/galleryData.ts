...
export const galleryLocations: GalleryLocation[] = [
  ...
  },
  {
    ...
    slug: "madinah",
    images: [
      { src: gallery1, caption: "Masjid Nabawi" },
      { src: gallery3, caption: "Jabal Uhud" },
      { src: gallery1, caption: "Raudhah" },
      { src: gallery3, caption: "Masjid Quba" },
      { src: gallery1, caption: "Pemakaman Baqi" },
      { src: gallery3, caption: "Museum Nabawi" },
      { src: gallery1, caption: "Masjid Qiblatain" },
      { src: gallery3, caption: "Uhud Mountain" },
      { src: gallery1, caption: "Pasar Kurma" },
      { src: gallery3, caption: "Jabal Uhud Sunset" },
    ],
  },
  {
    name: "Makkah",
