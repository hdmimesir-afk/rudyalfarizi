...
export const galleryLocations: GalleryLocation[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: alUla7, caption: "Maraya Mirror Building", portrait: true },
      { src: alUla8, caption: "Elephant Rock Al Ula" },
      { src: alUla9, caption: "Foto Bersama Tim di Al Ula", portrait: true },
      { src: alUla10, caption: "Selfie di Elephant Rock", portrait: true },
    ],
  },
  {
